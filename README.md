...
the tuple of `(isolation_scope, current_scope) being used to send events to Sentry. Use `with use_isolation_scope` to temporarily switch context. You can use this to set custom tags like so::
